...
from routes.project_guidance import router as project_guidance_router
...
_ = (rag_router, video_router, research_runs_router, chat_generation_runs_router, youtube_router)
